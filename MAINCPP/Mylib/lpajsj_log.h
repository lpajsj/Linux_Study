...
#define log_info(p,...) _log_info((char *)__FILE__,__LINE__,p,##__VA_ARGS__)
#define log_warn(p,...) _log_warn((char *)__FILE__,__LINE__,p,##__VA_ARGS__)
#define log_debug(p,...) _log_debug((char *)__FILE__,__LINE__,p,##__VA_ARGS__)
#define log_error(p,...) _log_error((char *)__FILE__,__LINE__,p,##__VA_ARGS__)
